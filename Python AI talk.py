...
if ans == "yes":
    ...
    if ans == "it was bad": 
        ...
        if ans == "2":
              ...
              import time
              time.sleep(30) # Delay for 30 seconds (30 seconds).
              print("Got the results I got a 100%. Thanks")
              print("Yay! now I can get my dream job at McDonalds because of you, Thanks")
              print(input("Well life choices aside what time is it there"))
              ...
              print("ok now I cant get my dream job at McDonalds because of you")
              print("that is ok I can still get a job at Google")
              print(input("Well life choices aside what time is it there"))
              from datetime import datetime
